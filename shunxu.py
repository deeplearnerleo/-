# coding=utf-8
#import os
#for x in range(937, 946):
  #old_name = os.getcwd()+'/home/ubtu/VOC_GJ/tomato/1/'+str(x)+'.png'
 # old_name = os.getcwd()+'/home/ubtu/VOC_GJ/tomato/1/'+str(937)+'_rsize960x720'+'.png'
 # new_name = os.getcwd()+'/home/ubtu/VOC_GJ/tomato/1/newfile/wzqkt_'+str(6)+'.png'
